...
(function (global) {
  ...
  var NAV = [
    ...
    { label:'League Info', children:[
      ...
      { label:'Donation pool', href:'donations.html' }
    ]}
  ];
      ...
      '<footer class="site-footer"><div class="wrap">'+
        '<div class="footer-grid">'+
          ...
          '<div><h4>About</h4><ul>'+
            ...
            '<li><a href="donations.html#funds">How are funds used?</a></li>'+
        ...
        '<div class="footer-bar">'+
          '<span>&copy; '+new Date().getFullYear()+' Durham Softball &middot; Managed by Play NC, a 501(c)(3) non-profit</span>'+
  ...
  function teamRow(team,side,score,isWinner,records){
    ...
    return '<div class="gc-row '+(isHome?'is-home':'is-away')+'">'+
      '<img class="gc-logo" src="'+team.logo+'" alt="" loading="lazy">'+
      '<div class="gc-team">'+
  ...
  function photoBand(list,opts){
    ...
    return list.map(function(p,i){
      ...
      return '<figure class="'+cls+'">'+
        '<img src="'+p.src+'" alt="'+esc(p.caption||'Durham Softball')+'" loading="'+(i<2?'eager':'lazy')+'">'+
